            ...
            <View
                ...
                <KeyboardAvoidingView
                    ...
                    <LinearGradient
                        ...
                        className="flex-row p-2 align-top h-[80px] w-full"
                    >
                    ...
                    <ScrollView>
                        ...
                        <View className="px-5 pt-5 mt-2 mx-5">
                            <View className="flex-row justify-between items-center">
                                ...
                                <View className="flex-row items-center w-[55%]">
                                    ...
                                    <TextInput
                                        className="text-black ml-4 text-xl w-[90px] text-center bg-[#e1ebf3] rounded-lg border-[#62a3da] border-2"
                                        value={RDT}
                                        editable={false}
                        ...
                        <View className="p-3 mt-3" >
                            <View className="flex-row justify-between items-center">
                                ...
                                <View className="flex-row items-center w-[55%]">
                                    <TextInput
                                        className="text-black ml-4 text-xl w-[150px] text-center bg-[#e1ebf3] rounded-xl border-[#62a3da] border-2 pt-0"
                ...
                <TouchableOpacity className="bg-[#3a78a9]  px-1 py-2 absolute bottom-5 left-[28%] w-[36%]" onPress={() => save()}>
                    <Text className="text-slate-50 text-base font-semibold text-center">SAVE PROFILE</Text>
                </TouchableOpacity>
                <TouchableOpacity className="bg-[#6da2d4]  px-1 py-2 absolute bottom-5 right-[4%] w-[30%] rounded-lg" onPress={() => calculateWeightLoss()}>
