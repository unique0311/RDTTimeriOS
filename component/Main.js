	...
	return (
		...
		>
			...
			<View className="flex-auto flex-col bg-blue-400">
				...
				<TouchableOpacity className="basis-1/5"><ListCard text={`Espresso Log`} onPress={goToEspressoLog}></ListCard></TouchableOpacity>
				<TouchableOpacity className="basis-1/5"><ListCard text={`Espresso Profiles`} onPress={goToEspressoProfile}></ListCard></TouchableOpacity>
				<TouchableOpacity className="basis-1/5"><ListCard text={`Brew and End Time\nCalculators`} onPress={goToCalculator} ></ListCard></TouchableOpacity>
			</View>
		</View>
	);
};
